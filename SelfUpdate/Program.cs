    ...
    internal static class Program
    {
        ...
        private static void Main(string[] arg)
        {
            ...
            try
            {
                ...
                logger.Info("************************************************************************");
                logger.Info("{0} v{1} Starting up", Process.GetCurrentProcess().ProcessName,
        ...
        internal static void StartXbmcUpdate()
        {
            try
            {
                ...
                Process xbmcUpdate = Process.Start(pStart);
        ...
        private static void SetupNlog()
        {
            ...
            {
                MessageBox.Show(String.Format("Fatal Logger Error.{0}{1}", Environment.NewLine, e), "SelfUpdate Error",
